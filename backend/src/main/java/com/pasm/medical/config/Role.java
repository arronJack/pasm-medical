 ...
 *
 * <p>★ <b>能力模型（P1-2 落地范围，如实标注）</b>：
 * <ul>
 *   <li>患者 —— 只能看**本人**的数据（ref 由令牌决定，不接受请求参数）</li>
 *   <li>医护人员 —— 属"医护侧"，可读后台的患者/审计/统计，范围限**本科室**；
 *       对资料库仍 403（临床读资料走问答接口，不需要资料库后台）</li>
 *   <li>科室管理员 —— 医护侧 + <b>本科室资料库写权限</b>（P1-2）：只能管本科室资料，
 *       跨科室 / 全院通用（空科室）资料不能动</li>
 *   <li>超级管理员 —— 全院范围，且是**唯一**能改系统配置的角色；
 *       资料库可管全院通用与各科室（"患者数据会不会出网"这类设置不属于科室权限）</li>
 * </ul>
 *
 * <p>★ P1-2（2026-09-23）起，<b>医护人员与科室管理员已拉开真实能力差异</b>：
 * 资料库带科室维度后，科室管理员成为第一个能写资料库的角色（限本科室）。
 * 在此之前二者只共享同一档能力 —— 那是因为资料库没有科室维度，
